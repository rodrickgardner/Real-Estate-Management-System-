...
<body>
	...
	<section id="secondary_bar">
		<div class="user">
			<p><?php if(isset($_SESSION['myusername'])); ?> (<a href="admin_home.php">Admin</a>)</p>
...
<aside id="sidebar" class="column">
	...
	<section id="main" class="column">
	  <article class="module width_full">
       ...
       $link2= mysqli_connect("$host","$username","$password")or die("cannot connect");
        mysqli_select_db($link2,"$db_name")or die("cannot select DB");
